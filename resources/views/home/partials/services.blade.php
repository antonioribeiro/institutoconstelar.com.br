            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="margin-btm-40">
                        <h4>Flexibilidade é nosso nome</h4>
                        <p>
                            Nós prestamos alguns serviços, mas tudo o que está ligado à psicoterapia e à gestalt terapia nos interessa, portanto se você gostaria de se tornar um parceiro, tem alguma sugestão ou acha que pode contribuir de alguma maneira, por favor, <a href="#contact">entre em contato</a>!
                        </p>
                    </div>
                </div>
            </div>
